...
%rouge les ruptures détectées par l'algorithme CUSUM récursif. Le paramètre
%plt est booléen et permet de dire si l'on veut ou non visualiser les
%résultats de segmentation. En sortie : sumdiff est le RMSD, N est le
%nombre de double-ruptures détectées par CUSUM (point de vue online, avec
%un seuil thresh), P est le nombre de bonnes ruptures, m est le nombre de
%ruptures.
%
